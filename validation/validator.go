...
type ValidationError struct {
	...
	Fixes        []barrelman.Fix  // suggested fixes
}
...
func (v *SchemaValidator) Validate(content []byte, version string, pointerIndex map[string]barrelman.Range) []ValidationError {
...
func flattenValidationErrors(root *jsonschema.ValidationError, pointerIndex map[string]barrelman.Range) []ValidationError {
