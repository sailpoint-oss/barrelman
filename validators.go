...
// V provides composable validator constructors.
var V = struct {
...
// FieldValidation pairs a field accessor with a validator.
...
// ValidateOperationFields returns an Operation visitor that validates fields.
func ValidateOperationFields(fields ...FieldValidation) func(string, string, *navigator.Operation, *Reporter) {
	return func(path string, method string, op *navigator.Operation, r *Reporter) {
...
// ValidateSchemaFields returns a Schema visitor that validates fields.
func ValidateSchemaFields(fields ...FieldValidation) func(string, *navigator.Schema, string, *Reporter) {
	return func(name string, schema *navigator.Schema, pointer string, r *Reporter) {
		for _, f := range fields {
...
func operationFieldValue(op *navigator.Operation, field string) (string, navigator.Loc) {
	switch field {
...
func schemaFieldValue(schema *navigator.Schema, field string) (string, navigator.Loc) {
	switch field {
	case "Type", "type":
